...
var $Chadtech$elm_relational_database$Id$toString = function (_v0) {
	var str = _v0.a;
	return str;
};
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		...
		if (result_flags.$ === 'Ok') {
			...
			var _v1 = $author$project$Data$Internal$init(flag_value);
			var data = _v1.a;
			var rcmd = _v1.b;
			return _Utils_Tuple2(
				{
...
var $Chadtech$elm_relational_database$Db$filter = F2(
	function (rowFilterFunction, _v0) {
		var dict = _v0.a;
		var uncurried = F2(
			function (key, value) {
...
var $Chadtech$elm_relational_database$Db$toList = function (_v0) {
	var dict = _v0.a;
	return A2(
		$elm$core$List$map,
...
var $author$project$Data$Generation$coding_frame = F2(
	function (model, _v0) {
		...
		if (((_v1.a.$ === 'Just') && (_v1.b.$ === 'Just')) && (_v1.c.$ === 'Just')) {
			...
			if (((_v4.a.$ === 'Just') && (_v4.b.$ === 'Just')) && (_v4.c.$ === 'Just')) {
				var question = _v4.a.a;
				var answers = _v4.b.a;
				var head = _v4.c.a;
				return $elm$core$Maybe$Just(
					A2(
...
var $author$project$Data$generateCodingFrame = F2(
	function (model, coding) {
		var _v0 = A2($author$project$Data$Generation$row_coding_frame, model, coding);
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			var generator = _v0.a;
...
var $author$project$Data$accessFirstCodingFrameOfQuestion = F3(
	function (model, coding, mbquestion) {
		var mbsame = A3(
			...
			mbquestion,
			A2($author$project$Data$Access$current_question, model, coding));
		var _v0 = _Utils_Tuple2(mbsame, mbquestion);
...
var $author$project$Data$moveQuestion = F3(
	function (model, direction, coding) {
		...
		if (current_index.$ === 'Nothing') {
			...
			var _v1 = _Utils_Tuple2(direction, index);
			if (_v1.a.$ === 'Previous') {
				if (!_v1.b) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Data$optionalUpdate = F3(
	function (id, database, updater) {
		if (id.$ === 'Just') {
			var id_value = id.a;
			var _v1 = A2($Chadtech$elm_relational_database$Db$get, database, id_value);
			if (_v1.$ === 'Just') {
				var value = _v1.a;
				var _v2 = updater(value);
				var newValue = _v2.a;
				var newCmd = _v2.b;
				return A2(
...
var $author$project$Entities$Timestamp$updateTimestamp = F2(
	function (msg, object) {
		var _v0 = A2($author$project$Entities$Timestamp$update, msg, object.timestamp);
		var new_timestamp = _v0.a;
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Generate':
				...
				var _v1 = _Utils_Tuple2(object, coding_frame);
				switch (_v1.a.$) {
					case 'CodingFrame':
...
var $author$project$Page$update = F3(
	function (msg, data, model) {
		switch (msg.$) {
			case 'Mdc':
				var msg_ = msg.a;
				var _v1 = A3($author$project$Material$update, $author$project$Page$Mdc, msg_, model);
				var mdc = _v1.a;
				var effect = _v1.b;
			...
			case 'PageMsg':
				...
				if ((m.$ === 'GotLoginMsg') && (m.a.$ === 'Select')) {
					...
					var _v3 = A3($author$project$Page$updatePage, m, model.page, data);
					var page = _v3.a;
					var effects = _v3.b;
					var pmsg = _v3.c;
					return _Utils_Tuple3(
			...
			case 'Internal':
				var msg_ = msg.a;
				var _v4 = A3($author$project$Page$Internal$update, $author$project$Page$Internal, msg_, model.internal);
				var internal = _v4.a;
				var effects = _v4.b;
				return _Utils_Tuple3(
					_Utils_update(
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				case 'GotPageMsg':
					var msg_ = msg.a;
					var _v1 = A3($author$project$Page$update, msg_, model.data, model.page);
					var page = _v1.a;
					var effect = _v1.b;
					var mbpmsg = _v1.c;
							...
							case 'SelectCoding':
								...
								var _v4 = A2(
									...
									_Utils_update(
										model,
										{page: new_page}));
								var newest_model = _v4.a;
								var newest_effect = _v4.b;
								var _v5 = A2(
				...
				case 'GotDataMsg':
					var msg_ = msg.a;
					var _v6 = A2($author$project$Data$update, msg_, model.data);
					var data = _v6.a;
					var effect = _v6.b;
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Page$Internal$Drawer$headerFromCoder = function (_v0) {
	var cid = _v0.a;
	var model = _v0.b;
	return {
...
var $author$project$Db$Extra$get = F3(
	function (b, accessor, _v0) {
		var ida = _v0.a;
		var valuea = _v0.b;
		var idb = accessor(valuea);
		var _v1 = A2($Chadtech$elm_relational_database$Db$get, b, idb);
		if (_v1.$ === 'Just') {
			var valueb = _v1.a;
...
var $author$project$Page$Code$viewNextAnswer = F6(
	function (lift, mdc, data, _v0, cur, max) {
		var id = _v0.a;
		var coding = _v0.b;
		var _v1 = A2(
...
var $author$project$Page$Code$viewNextQuestion = F5(
	function (lift, mdc, _v0, cur, max) {
		var id = _v0.a;
		var coding = _v0.b;
		var _v1 = _Utils_eq(cur, max);
		if (_v1) {
			return A2($elm$html$Html$div, _List_Nil, _List_Nil);
		} else {
			return A5(
...
var $author$project$Data$Access$has_previous_coding_frame = F2(
	function (model, coding) {
		var _v0 = A2($author$project$Data$Access$current_codingFrame_index, model, coding);
		if (_v0.$ === 'Nothing') {
			return false;
		} else {
			if (!_v0.a) {
...
var $author$project$Page$Home$coding2card = function (_v0) {
	var id = _v0.a;
	var value = _v0.b;
	return {
...
var $author$project$Page$Login$viewCoderRow = function (_v0) {
	var id = _v0.a;
	var model = _v0.b;
	return A2(
...
var $author$project$Main$view = function (model) {
	var _v0 = A2($author$project$Page$view, model.page, model.data);
	var title = _v0.title;
	var body = _v0.body;
	return {
		body: A2(
